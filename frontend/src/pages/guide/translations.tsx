...
export const translations: Record<Language, RulesContent> = {
    ua: {
        ...
        howItWorksItems: [
            ...
            'Дуже важливо оцінювати кожен трек. Для цього сервіс публікує голосування в Discord. Результати голосування впливають на те, чи буде цей трек обраний знову.',
        ],
    ...
    en: {
        ...
        howItWorksItems: [
            ...
            'It is very important to rate each track. The service publishes a poll in Discord. Poll results affect whether the track will be selected again.',
        ],
        dayStreakTitle: 'Day Streak',
