...
import type { GetApiMigrationSomethingData, GetApiPilotsAllData, GetApiPilotsAllResponse, GetApiPilotsProfileData, GetApiPilotsProfileResponse, GetApiResultsForPilotData, GetApiResultsForPilotResponse, GetApiCompetitionsCurrentData, GetApiCompetitionsCurrentResponse, GetApiDashboardData, GetApiDashboardResponse, GetApiRatingsGetData, GetApiRatingsGetResponse } from './types.gen';

export const client = createClient(createConfig());

export const getApiMigrationSomething = <ThrowOnError extends boolean = false>(options?: Options<GetApiMigrationSomethingData, ThrowOnError>) => {
