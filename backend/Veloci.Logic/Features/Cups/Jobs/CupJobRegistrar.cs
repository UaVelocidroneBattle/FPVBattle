...
public class CupJobRegistrar : IJobRegistrar
{
    ...
    public void RegisterJobs()
    {
        ...
        _log.Information("Found {CupCount} enabled cups: {CupIds} (registering start, stop, stop-poll and season-results jobs)", enabledCupIds.Count, string.Join(", ", enabledCupIds));
